...
class MainActivity : NavigationActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private fun tryToEmit(eventName: String, event: WritableMap) {
        try {
            ...
            // we expect NPE on first start, which is OK because we have a fallback
        }
    }
    ...
    fun requestPermissions(permissions: Array<String>, requestCode: Int, listener: PermissionListener) {
